...
% personal data
\name{Hebert Hernández}{Martínez}
% \title{Curriculum Vitae}                               % optional, remove / comment the line if not wanted
\address{Querétaro, Qro }{}{}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
% \phone[mobile]{+52 55-5434-4385}                   % optional, remove / comment the line if not wanted
% \phone[fixed]{01234 123456}                    % optional, remove / comment the line if not wanted
% \phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
% \email{hebert.hernandez7@gmail.com}                               % optional, remove / comment the line if not wanted
% \homepage{evertcode.me}                         % optional, remove / comment the line if not wanted
...
\begin{tabular}{ c c c c }
 \faGlobe\enspace evertcode.me & \faEnvelopeO\enspace hebert.hernandez7@gmail.com & \faGithub\enspace evertcode &  \faMobile\enspace +52 55-5434-4385\\  
\end{tabular}
\end{center}
